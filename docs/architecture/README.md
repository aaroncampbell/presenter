# Presenter architecture decisions

Architecture decision records document choices that would be costly or risky to
rediscover during the Presenter 2.0 rewrite.

- [ADR 0001: Presenter 2.0 baseline](0001-presenter-2-baseline.md)
- [ADR 0002: Deck and Slide block content model](0002-deck-and-slide-blocks.md)
- [ADR 0003: Fidelity-first legacy migration](0003-legacy-migration.md)
