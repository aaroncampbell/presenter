...
$presenter_feature_plugins = \Presenter\Reveal_Config::plugins_for_markup( $presenter_slides );
$presenter_plugins         = apply_filters( 'presenter_reveal_plugins', $presenter_feature_plugins, $presenter_post );
